"""recipes/04-train/text-to-sql: the verifier's matching rule, the shipped task set, and
...
EXAMPLE = Path(__file__).resolve().parents[2] / "recipes" / "04-train" / "text-to-sql"
