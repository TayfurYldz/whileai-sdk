...
IDENTITY = EXAMPLES / "04-train/identity"
...
def test_readme_counts_the_template_banks_right():
    ...
    assert "tests/recipes/test_identity_example.py" in text
...
def test_modal_scripts_import_and_their_flags_match_the_readme():
    ...
    assert_readme_matches_entrypoints(
        README,
        {
            "recipes/04-train/identity/train_modal.py": train.main,
            "recipes/04-train/identity/eval_modal.py": ev.main,
        },
    )
