...
is the scoring. Usage:
    ...
    modal run recipes/04-train/identity/eval_modal.py \
        --adapter identity-v1/adapter \
        --holdout-file recipes/04-train/identity/out/identity_holdout.jsonl \
        --probe-file recipes/04-train/identity/out/leak_probes.jsonl \
